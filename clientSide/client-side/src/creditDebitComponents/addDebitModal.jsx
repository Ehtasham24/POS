...
// vendor again, since it's already known. Left undefined when opened from the page-level
// "Add Payable" button, which still needs the full picker.
const AddDebitModal = ({ isOpen, onClose, onAdded, presetContactId }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={presetContactId ? t("creditDebit.addCharge") : t("creditDebit.addPayable")}>
